(function() {
    ...
    MainController.$inject = ['$scope', 'Principal', 'LoginService', '$state', 'LocalTur', '$timeout', 'orderByFilter'];

    function MainController ($scope, Principal, LoginService, $state, LocalTur, $timeout, orderByFilter) {
        var vm = this;
